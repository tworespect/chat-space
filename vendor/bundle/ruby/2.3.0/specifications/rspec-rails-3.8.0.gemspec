# -*- encoding: utf-8 -*-
# stub: rspec-rails 3.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rspec-core>, ["~> 3.8.0"])
      s.add_runtime_dependency(%q<rspec-expectations>, ["~> 3.8.0"])
      s.add_runtime_dependency(%q<rspec-mocks>, ["~> 3.8.0"])
      s.add_runtime_dependency(%q<rspec-support>, ["~> 3.8.0"])
      ...
      s.add_dependency(%q<rspec-core>, ["~> 3.8.0"])
      s.add_dependency(%q<rspec-expectations>, ["~> 3.8.0"])
      s.add_dependency(%q<rspec-mocks>, ["~> 3.8.0"])
      s.add_dependency(%q<rspec-support>, ["~> 3.8.0"])
