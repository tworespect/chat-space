# -*- encoding: utf-8 -*-
# stub: rubocop-rspec 1.30.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/rubocop-hq/rubocop-rspec"
  s.licenses = ["MIT"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rubocop>, [">= 0.58.0"])
      ...
      s.add_dependency(%q<rubocop>, [">= 0.58.0"])
